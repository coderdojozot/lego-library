...
async def missie_roodA_start():
    ...
    await vooruit(99)
    await links(15)
    await linkerarm.run_angle(600, -1800) # kraan draaien
    await rechts(20)
    await achteruit(80)
    await links(90)
    await vooruit(170)
    await links(47)
    await vooruit(192)
    await rechterarm.run_angle(600, -180) # arm naar benden bij tafel
    await achteruit(180)
    await rechterarm.run_angle(500, 180)
    await links(90)
    await vooruit(257)
    await rechts(45)
    await vooruit(195)
    await rechts(90)
    await rechterarm.run_angle(600, -190)
    await rechterarm.run_angle(600, 190)
    await achteruit(20)
    await rechts(90)
    await vooruit(255)
    await links(91)
    await vooruit(25)
    await rechterarm.run_angle(600, -185)
    await rechts(89)
    await vooruit(120)
    await rechts(90)
    await vooruit(900)
